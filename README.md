...
- 📦 **最新版下载（GitHub）**：请前往 [GitHub Releases 页面](https://github.com/zys5807/AIReview/releases/latest) 下载 `AIReviewSystem-V1.009.10-clean.zip`（GitHub 资产名不支持中文，此即清洁版，不含任何个人数据）
- 📦 **最新版下载（Gitee）**：请前往 [Gitee 发行版页面](https://gitee.com/zys5807/AIReview/releases) 下载 `AIReviewSystem-V1.009.10-清洁版.zip`
...
- 🧭 **A股每日复盘**：一键采集当日盘面全貌——8 大指数、涨跌家数与涨停/跌停/炸板梯队、连板高度、两市成交额与量能变化、概念板块温度、人气热度榜、龙虎榜游资、严重异动提醒；**支持 60 个交易日内任意历史日回溯**（日K自建口径，涨跌停判定精确到除权参考价与各板块取整规则）；每个指标都带「?」备注说明计算口径；主线题材表可展开查看**板块龙头 / 中军 / 跟风 / 补涨**四类角色股；附 AI 盘面点评与手写复盘（草稿自动缓存）
