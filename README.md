...
- 📦 **最新版下载**：请前往 [GitHub Releases 页面](https://github.com/zys5807/AIReview/releases/latest) 下载 `AIReviewSystem-V1.006.1-清洁版.zip`
...
- 📈 **阶段绩效指标**：平均单笔盈亏比、日平均仓位、阶段总收益率、最大回撤、最大周度回撤、卡玛比率、夏普比率（需先录入账户资金流水）
