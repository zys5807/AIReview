...
- 📦 **最新版下载**：请前往 [GitHub Releases 页面](https://github.com/zys5807/AIReview/releases/latest) 下载 `AIReviewSystem-V1.006.2-清洁版.zip`
...
- 💰 **收益率与仓位**：按品种自动计算占用资金（66 个期货品种乘数表，支持名称容错匹配）与单笔收益率；账户资金流水管理，交易计划自动计算单笔/总仓位比例
- 📈 **阶段绩效指标**：阶段期初/期末资金（随所选时间段动态计算，含此前交易盈亏）、平均单笔盈亏比、日平均仓位、阶段总收益率、最大回撤、最大周度回撤、卡玛比率、夏普比率（需先录入账户资金流水）
