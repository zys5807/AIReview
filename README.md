...
- 📦 **最新版下载**：请前往 [GitHub Releases 页面](https://github.com/zys5807/AIReview/releases/latest) 下载 `AIReviewSystem-V1.006-清洁版.zip`
...
- 💰 **收益率与仓位**：按品种自动计算占用资金（66 个期货品种乘数表，支持名称容错匹配）与单笔收益率；账户资金流水管理（支持人民币 CNY / 美元 USD 双币种，USDT 按 1:1 并入美元），交易计划自动计算单笔/总仓位比例；数字货币占用资金 = USDT 持仓规模
